...
const zh: Record<string,string> = {
  ...
  'Scan readiness':'\u626b\u63cf\u51c6\u5907\u72b6\u6001','Run required scan':'\u6267\u884c\u6240\u9700\u626b\u63cf','Revision history':'\u4fee\u8ba2\u5386\u53f2','Restore':'\u6062\u590d','Latest change':'\u6700\u65b0\u53d8\u66f4','New unsaved workflow':'\u65b0\u5efa\u672a\u4fdd\u5b58\u5de5\u4f5c\u6d41','Scan only':'\u4ec5\u626b\u63cf','Generate a draft preview after scanning':'\u626b\u63cf\u5b8c\u6210\u540e\u751f\u6210\u8349\u7a3f\u9884\u89c8',
