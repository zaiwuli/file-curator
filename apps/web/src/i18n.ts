...
const zh: Record<string,string> = {
  ...
  'unresolved':'未处理','accepted':'已接受','keep':'保持不变','override':'手动覆盖','draft':'草稿','frozen':'已冻结','confirmed':'已确认','queued':'排队中','processing':'处理中','completed':'已完成','failed':'失败','cancelled':'已取消','paused':'已暂停','rolled back':'已回滚','rename':'改名','move':'移动','quarantine':'隔离',
